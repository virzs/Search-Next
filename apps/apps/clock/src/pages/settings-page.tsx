...
export function SettingsPage({ settings, saving, onSave, t }: { settings: ClockSettings; saving: boolean; onSave: (next: ClockSettings) => Promise<void>; language: AppLanguage; t: AppTranslationFn }) {
    ...
    <div className={frameClassName}>
      <aside className={sidebarClassName}>
        ...
        <nav className={navClassName} aria-label={t("settings.title")}>
          ...
          <span className={navItemClassName()}>{t("settings.nav.app")}</span>
        </nav>
      </aside>
