const enUS = {
  ...
  "routes.account.root.description": "Sign in, register, and view account details",
  ...
  "routes.account.profile.description": "View current account details",
  "routes.store.root.title": "App Store",
  "routes.store.root.description": "Discover websites, apps, and desktop widgets",
  ...
  "routes.store.dev.description": "Test custom widgets and local ESM entries",
  ...
  "routes.settings.developer.description": "Widget development entry",
  "app.languageChanged": "Language changed to {{language}}",
  "widget.loadFailed": "Widget failed to load",
  "action.apply": "Apply",
  "ui.search": "Search",
  ...
  "ui.widgetDevelopment": "Widget Development",
  "ui.developerMode": "Developer Mode",
  "ui.dev.modeDescription": "Use custom widgets and local ESM entries for testing.",
  ...
  "ui.auth.signInSyncSubtitle": "Sign in to sync desktop layout, websites, widgets, and preferences.",
  ...
  "ui.backup.widgetDescription": "Installed widgets and private widget storage",
  ...
  "ui.developerModeAndLocalWidgetEntries": "Developer mode and local widget entries",
  ...
  "ui.backup.storageUsageDescription": "View storage usage for desktop, settings, widgets, and more",
  ...
  "ui.store.widgetHeroDescription": "Preview light or dark mode, compare screenshots in different sizes, then add the right size to the desktop.",
  ...
  "ui.theme.editorDescription": "Configure light, dark, and accent colors, then save and apply directly to the desktop.",
  ...
  "ui.debugCustomWidgets": "Debug Custom Widgets",
  "ui.dev.customWidgetsDescription": "Manage ESM entry URLs and size configs for debugging local widgets or backend-unpacked widget entries.",
  "ui.noCustomWidgets": "No custom widgets",
  "ui.add": "Add",
  "ui.addToDesktop": "Add to Desktop",
  "ui.deleteThisWidget": "Delete this widget?",
  "ui.updated": "Updated",
  "ui.addedToDesktop": "Added to desktop",
  "ui.removed": "Removed",
  "ui.dev.duplicateEntry": "This entry URL already exists. Do not add it again.",
  "ui.editWidget": "Edit Widget",
  "ui.addWidget": "Add Widget",
  "ui.eSMEntryURL": "ESM Entry URL",
  "ui.enterAWidgetName": "Enter a widget name",
