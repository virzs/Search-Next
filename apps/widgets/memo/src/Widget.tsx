...
const readValue = async <T,>(sdk: WidgetSDK | undefined, key: string, fallback: T): Promise<T> => {
...
const writeValue = async (sdk: WidgetSDK | undefined, key: string, value: unknown) => {
