...
export class NoticeController {
  ...
  @Get("/inbox")
  @SkipPermission()
  @ApiOperation({ summary: "当前登录用户的生效公告列表" })
  @ApiQuery({ name: "key", description: "公告端标识", required: true })
  inbox(@Query("key") key: string) {
    return this.noticeService.inbox(key || "admin");
  }
