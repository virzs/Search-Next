...
export const languageStorageKey = "search-next-app-language";
...
export const createAppI18n = (resources) => {
...
export const createAppTranslator = (resources, language) => {
...
export const setStandaloneAppLanguage = (language) => {
  const locale = {
