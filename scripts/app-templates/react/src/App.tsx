...
const App = ({ mode = "icon", sdk }: AppProps) => {
  ...
  return (
    <div className={shellClassName}>
      <div className="tw:text-[11px] tw:font-bold tw:uppercase tw:tracking-[0.08em] tw:opacity-75">
        {isSettings ? t("label.settings") : t("label.app")}
      </div>
      <div className="tw:text-[22px] tw:font-extrabold tw:leading-tight">__APP_DISPLAY_NAME__</div>
      {!isIcon && (
