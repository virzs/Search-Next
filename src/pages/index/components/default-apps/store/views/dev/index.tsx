    ...
    <DefaultAppView contentClassName="flex flex-col overflow-hidden pt-5 px-1 pb-4">
      ...
      <div className="shrink-0">
        <StoreHeroCard
          subtitle="开发者"
          title="自定义小组件测试"
          description="推荐将 widgets/<name> 打包为 .snwidget 上传后台；这里仅保留远程入口调试。"
      ...
      <div className="mt-5 shrink-0 px-1">
        <Alert
          ...
          description="请在 widgets/<name> 编写源码，执行 npm run widget:pack -- <name> 生成 .snwidget 后到后台导入，线上从后端 /static/widgets/... 地址加载。"
        />
