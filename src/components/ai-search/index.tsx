...
const AISearchComponent: React.FC = () => {
  // 示例对话内容
    ...
    <>
      ...
      >
        <Button
          ...
          `}
        >
          <RiRobot2Line size={20} style={{ color: "#667eea", marginRight: 12 }} />
          <span style={{ color: "#999", fontSize: "16px" }}>点击开始 AI 搜索...</span>
        </Button>
      </div>

      {/* AI搜索模态框 */}
      <DesktopBaseModal visible={modalVisible} onClose={handleModalClose} width={1000}>
        <div
          className={cx(
